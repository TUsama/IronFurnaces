...
public class StringHelper {
    ...
    public static List<Component> getShiftInfoGui()
    {
        ...
        MutableComponent tooltip1 = Component.translatable("tooltip." + ForgeEntrypoint.MOD_ID + ".gui_hold_shift");
        MutableComponent shift = Component.literal("[Shift]");
        MutableComponent tooltip2 = Component.translatable("tooltip." + ForgeEntrypoint.MOD_ID + ".gui_shift_more_options");
    ...
    {
        MutableComponent tooltip1 = Component.translatable("tooltip." + ForgeEntrypoint.MOD_ID + ".hold");
        MutableComponent shift = Component.literal("[Shift]");
        MutableComponent tooltip2 = Component.translatable("tooltip." + ForgeEntrypoint.MOD_ID + ".for_details");
        tooltip1.withStyle(ChatFormatting.GRAY);
        shift.withStyle(ChatFormatting.GOLD, ChatFormatting.ITALIC);
        tooltip2.withStyle(ChatFormatting.GRAY);
