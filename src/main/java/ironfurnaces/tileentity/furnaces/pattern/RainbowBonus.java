...
public record RainbowBonus(
    ...
    public static final RainbowBonus ZERO = new RainbowBonus(0, 0, 0, 0, 0);

    public static final Codec<RainbowBonus> CODEC = RecordCodecBuilder.create(inst -> inst.group(
            Codec.INT.optionalFieldOf("smelt_tick_per_item_offset", 0).forGetter(RainbowBonus::smeltTickPerItemOffset),
