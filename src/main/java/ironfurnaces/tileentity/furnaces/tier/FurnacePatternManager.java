...
public final class FurnacePatternManager {
    ...
    public static FurnacePattern get(ResourceLocation id) {
        ...
        if (furnacePattern == null) IronFurnaces.LOGGER.error("Found unavailable Pattern: {}, fall back to hardcoded Basic Pattern", id);
    ...
    public static void sortPatternsByRules(Collection<TierUpgradeRule> rules) {
